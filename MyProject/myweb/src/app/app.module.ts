...
import { CcTimetableComponent } from './cc-timetable/cc-timetable.component';
import { ExternalmarksComponent } from './externalmarks/externalmarks.component';
import { CcExternalmarksComponent } from './cc-externalmarks/cc-externalmarks.component';
...
@NgModule({
  declarations: [
    ...
    ProfileComponent,
    CcResultsComponent,
    CcTimetableComponent,
    ExternalmarksComponent,
    CcExternalmarksComponent,
